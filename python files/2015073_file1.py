...
test_label="/Users/priyarajpurohit/Desktop/bonus-sml-2020/2015073_file1.csv"
model_label="2015073_file1.pkl"
X_train_raw = []
y_train_raw = []
X_test_raw = []
y_test_raw = []
...
predicted= lda.predict(X_test_raw)
pickle.dump(lda, open(model_label, 'wb'))
