...
TEST_LABEL = "/Users/priyarajpurohit/Desktop/bonus-sml-2020/2015073_Priya_submission2.csv"
test_label="/Users/priyarajpurohit/Desktop/bonus-sml-2020/2015073_file2.csv"
model_label="2015073_file2.pkl"
X_train_raw = []
y_train_raw = []
X_test_raw = []
y_test_raw = []
...
kn.fit(X_train_raw,y_train_raw)
predicted= kn.predict(X_test_raw)
pickle.dump(kn, open(model_label, 'wb'))
