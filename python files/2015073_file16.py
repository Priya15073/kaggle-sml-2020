...
TEST_LABEL = "/Users/priyarajpurohit/Desktop/Desktop – Priya’s MacBook Prop/bonus-sml-2020/2015073_Priya_submission.csv"
test_label="/Users/priyarajpurohit/Desktop/Desktop – Priya’s MacBook Pro/bonus-sml-2020/2015073_model16.csv"
model_label="2015073_model16.pkl"
hog_train = []
hsv_train=[]
...
for i in range(16000):
    ...
    fd = hog(im, orientations=15, pixels_per_cell=(20, 20),cells_per_block=(2, 2),block_norm= 'L2')
    hog_train.append(fd)
...
clf= RandomForestClassifier(n_estimators=500,max_depth=30, random_state=42,class_weight='balanced',max_features='sqrt')
#clf=AdaBoostClassifier(base_estimator=rf_class,n_estimators=20,learning_rate=1)
