...
test_label="/Users/priyarajpurohit/Desktop/bonus-sml-2020/2015073_model11.csv"
model_label="2015073_model11.pkl"
X_train_raw = []
HOG_x_train=[]
HOG_x_test=[]
y_train_raw = []
...
for i in range(16000):
    ...
    #print(cv2.imread(f))
    im1 = cv2.imread(f)
    fd = hog(im1, orientations=8, pixels_per_cell=(8,8),cells_per_block=(1, 1),block_norm= 'L2', multichannel=True)
