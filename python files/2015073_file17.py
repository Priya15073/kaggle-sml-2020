...
test_label="/Users/priyarajpurohit/Desktop/Desktop – Priya’s MacBook Pro/bonus-sml-2020/2015073_model17.csv"
model_label="2015073_model17.pkl"
hog_train = []
hsv_train=[]
...
for i in range(16000):
    ...
    fd = hog(im, orientations=15, pixels_per_cell=(8, 8),cells_per_block=(2, 2),block_norm= 'L2')
    hog_train.append(fd)
